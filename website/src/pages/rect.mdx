...
From the command line in your project directory, run `npm install @yoziyo/rect` or `yarn add @yoziyo/rect`. Then import the component or hook that you need:

```bash
npm install @yoziyo/rect
# or
yarn add @yoziyo/rect
```

...
From the command line in your project directory, run `npm install @reach-ui-fork/rect` or `yarn add @reach-ui-fork/rect`. Then import the component or hook that you need:

```bash
npm install @reach-ui-fork/rect
# or
yarn add @reach-ui-fork/rect
```

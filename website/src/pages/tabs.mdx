...
From the command line in your project directory, run `npm install @reach-ui-fork/tabs` or `yarn add @reach-ui-fork/tabs`. Then import the components and styles that you need:

```bash
npm install @reach-ui-fork/tabs
# or
yarn add @reach-ui-fork/tabs
```
...
```jsx
import { TabsKeyboardActivation } from "@reach-ui-fork/tabs";
...
```jsx
import { TabsOrientation } from "@reach-ui-fork/tabs";

...
From the command line in your project directory, run `npm install @yoziyo/skip-nav` or `yarn add @yoziyo/skip-nav`. Then import the components and styles:

```bash
npm install @yoziyo/skip-nav
# or
yarn add @yoziyo/skip-nav
```

...
From the command line in your project directory, run `npm install @reach-ui-fork/skip-nav` or `yarn add @reach-ui-fork/skip-nav`. Then import the components and styles:

```bash
npm install @reach-ui-fork/skip-nav
# or
yarn add @reach-ui-fork/skip-nav
```

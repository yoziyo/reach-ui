...
From the command line in your project directory, run `npm install @reach-ui-fork/tooltip` or `yarn add @reach-ui-fork/tooltip`. Then import the components and styles that you need:

```bash
npm install @reach-ui-fork/tooltip
# or
yarn add @reach-ui-fork/tooltip
```

```js
import { Tooltip, TooltipPopup, useTooltip } from "@reach-ui-fork/tooltip";

...
From the command line in your project directory, run `npm install @yoziyo/tooltip` or `yarn add @yoziyo/tooltip`. Then import the components and styles that you need:

```bash
npm install @yoziyo/tooltip
# or
yarn add @yoziyo/tooltip
```

```js
import { Tooltip, TooltipPopup, useTooltip } from "@yoziyo/tooltip";

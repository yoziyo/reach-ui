...
From the command line in your project directory, run `npm install @reach-ui-fork/visually-hidden` or `yarn add @reach-ui-fork/visually-hidden`. Then import the component:

```bash
npm install @reach-ui-fork/visually-hidden
# or
yarn add @reach-ui-fork/visually-hidden
```

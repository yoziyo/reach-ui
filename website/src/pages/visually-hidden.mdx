...
From the command line in your project directory, run `npm install @yoziyo/visually-hidden` or `yarn add @yoziyo/visually-hidden`. Then import the component:

```bash
npm install @yoziyo/visually-hidden
# or
yarn add @yoziyo/visually-hidden
```

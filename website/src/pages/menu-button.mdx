...
From the command line in your project directory, run `npm install @yoziyo/menu-button` or `yarn add @yoziyo/menu-button`. Then import the components and styles that you need:

```bash
npm install @yoziyo/menu-button
# or
yarn add @yoziyo/menu-button
```
...
```jsx
import { Link } from "@yoziyo/router";
<MenuList>

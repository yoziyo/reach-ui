...
From the command line in your project directory, run `npm install @yoziyo/window-size` or `yarn add @yoziyo/window-size`. Then import the component or hook that you need:

```bash
npm install @yoziyo/window-size
# or
yarn add @yoziyo/window-size
```

...
From the command line in your project directory, run `npm install @reach-ui-fork/window-size` or `yarn add @reach-ui-fork/window-size`. Then import the component or hook that you need:

```bash
npm install @reach-ui-fork/window-size
# or
yarn add @reach-ui-fork/window-size
```

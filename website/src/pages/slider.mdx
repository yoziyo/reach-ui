...
From the command line in your project directory, run `npm install @reach-ui-fork/slider` or `yarn add @reach-ui-fork/slider`. Then import the components and styles that you need:

```bash
npm install @reach-ui-fork/slider
# or
yarn add @reach-ui-fork/slider
```

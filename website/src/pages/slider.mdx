...
From the command line in your project directory, run `npm install @yoziyo/slider` or `yarn add @yoziyo/slider`. Then import the components and styles that you need:

```bash
npm install @yoziyo/slider
# or
yarn add @yoziyo/slider
```

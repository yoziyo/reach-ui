...
- Source: https://github.com/reach/reach-ui/tree/main/packages/alert
...
From the command line in your project directory, run `npm install @reach-ui-fork/alert` or `yarn add @reach-ui-fork/alert`. Then import the component:

```bash
npm install @reach-ui-fork/alert
# or
yarn add @reach-ui-fork/alert
```

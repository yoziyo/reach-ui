...
From the command line in your project directory, run `npm install @yoziyo/alert` or `yarn add @yoziyo/alert`. Then import the component:

```bash
npm install @yoziyo/alert
# or
yarn add @yoziyo/alert
```

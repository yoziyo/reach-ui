...
From the command line in your project directory, run `npm install @yoziyo/accordion` or `yarn add @yoziyo/accordion`. Then import the components and styles that you need:

```bash
npm install @yoziyo/accordion
# or
yarn add @yoziyo/accordion
```

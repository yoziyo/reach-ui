...
If you have a group of disclosures that stack vertically and exist within the same logical context, you may want to use [`@yoziyo/accordion`](/accordion) instead.

## Installation

From the command line in your project directory, run `npm install @yoziyo/disclosure` or `yarn add @yoziyo/disclosure`. Then import the components that you need:

```bash
npm install @yoziyo/disclosure
# or
yarn add @yoziyo/disclosure
```

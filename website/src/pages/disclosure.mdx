...
If you have a group of disclosures that stack vertically and exist within the same logical context, you may want to use [`@reach-ui-fork/accordion`](/accordion) instead.

## Installation

From the command line in your project directory, run `npm install @reach-ui-fork/disclosure` or `yarn add @reach-ui-fork/disclosure`. Then import the components that you need:

```bash
npm install @reach-ui-fork/disclosure
# or
yarn add @reach-ui-fork/disclosure
```

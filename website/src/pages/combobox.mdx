...
From the command line in your project directory, run `npm install @reach-ui-fork/combobox` or `yarn add @reach-ui-fork/combobox`. Then import the components and styles that you need:

```bash
npm install @reach-ui-fork/combobox
# or
yarn add @reach-ui-fork/combobox
```

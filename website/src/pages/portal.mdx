...
From the command line in your project directory, run `npm install @reach-ui-fork/portal` or `yarn add @reach-ui-fork/portal`. Then import the component:

```bash
npm install @reach-ui-fork/portal
# or
yarn add @reach-ui-fork/portal
```

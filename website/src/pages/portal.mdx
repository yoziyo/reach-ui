...
From the command line in your project directory, run `npm install @yoziyo/portal` or `yarn add @yoziyo/portal`. Then import the component:

```bash
npm install @yoziyo/portal
# or
yarn add @yoziyo/portal
```

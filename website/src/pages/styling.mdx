...
`your-app/node_modules/@yoziyo/<package-name>/styles.css`
...
<link
	rel="stylesheet"
	type="text/css"
	href="https://unpkg.com/@yoziyo/<package-name>@<version>/styles.css"
/>
```
...
There are two types of selectors, "element" and "pseudo". The documentation for each component lists the selectors that apply to the component, but we're using `MenuItem` from `@yoziyo/menu-button` as an example here.

...
From the command line in your project directory, run `npm install @reach-ui-fork/alert-dialog` or `yarn add @reach-ui-fork/alert-dialog`. Then import the components that you need:

```bash
npm install @reach-ui-fork/alert-dialog
# or
yarn add @reach-ui-fork/alert-dialog
```

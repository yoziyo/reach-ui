...
From the command line in your project directory, run `npm install @yoziyo/alert-dialog` or `yarn add @yoziyo/alert-dialog`. Then import the components that you need:

```bash
npm install @yoziyo/alert-dialog
# or
yarn add @yoziyo/alert-dialog
```

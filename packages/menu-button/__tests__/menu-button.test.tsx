...
describe("<MenuButton /> with <MenuItem />", () => {
	...
	describe("rendering", () => {
		...
		it("menu button should have unique id generated by reach auto-id if it's not set specifically", () => {
			let { getByRole } = render(
				<Menu>
			...
			let button = getByRole("button");
			expect(button).toHaveAttribute("id", "menu-button--menu--REACH-ID");
		});
	});

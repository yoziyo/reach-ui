/**
 * Welcome to @reach-ui-fork/tooltip!
 *
	...
	if (__DEV__) {
		...
		React.useEffect(() => {
			if (DEPRECATED_ariaLabel) {
				console.warn(
					"The `ariaLabel prop is deprecated and will be removed from @reach-ui-fork/tooltip in a future version of Reach UI. Please use `aria-label` instead."
				);
			}
